...
export class MainNav {
  ...
  private toggleDD(myDropMenu): void {
    document.getElementById(myDropMenu).classList.toggle("invisible");
  }

  private filterDD(myDropMenu, myDropMenuSearch): void {
  ...
  @Listen("click")
  closeDD(event: UIEvent) {
    if (
      !(event.target as HTMLElement).matches(".drop-button") &&
      !(event.target as HTMLElement).matches(".drop-search")
    ) {
            ...
            <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
              ...
              <li class="flex-1 md:flex-none md:mr-3">
                <div class="relative inline-block">
                  <button
                    onClick={() => this.toggleDD("myDropdown")}
                  ...
                  >
                    <input
                      ...
                      placeholder="Search.."
                      id="myInput"
                      onKeyUp={() => this.filterDD("myDropdown", "myInput")}
                    />
                    <a
                      href="#"
